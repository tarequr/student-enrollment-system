  ...
  <div class="container-fluid">
      <div class="page-title-box">
          <div class="row align-items-center">
            <div class="col-sm-6">
              <h4 class="mt-0 header-title mb-4">Update Department</h4>
            </div>
            <div class="col-sm-6">
          ...
          <div class="card">
            <div class="row card-body justify-content-center">
              ...
              <div class="col-md-11 mb-5 mt-2">
                <form class="user" method="POST" action="{{ route('department.update',$editData->id) }}" >
                   @csrf
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="submit" name="btn" class="btn btn-primary btn-user btn-block" value="Update Department">
                    </div>
                  </div>
                </form>
              </div>
